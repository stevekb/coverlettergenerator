...
p0 = ("Your job opportunity on " + str(jobsite) + " for a " + str(jobname)
    + " interests me. With my experience in " + str(skills[skill_1][0]) + ", "
    + str(skills[skill_2][0]) + " and " + str(skills[skill_3][0])
...
p4 = ("After you have read my resume for the details of my qualifications,"
    ...
    + str(skills[skill_1][0]) + ", " + str(skills[skill_2][0]) + " and "
    + str(skills[skill_3][0]) + " will benefit you at " + str(company) +
